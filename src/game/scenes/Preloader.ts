...
export class Preloader extends Scene {
    ...
    loadStudentSprites() {
        ...
        // Girl student sprites (single-frame per direction)
        this.load.image("student-girl-front", "front/front-girl.png");
        this.load.image("student-girl-back", "back/back-girl.png");
        this.load.image("student-girl-left", "left/left-girl.png");
        this.load.image("student-girl-right", "right/right-girl.png");
    ...
    loadLevel3NPCImages() {
        console.log(
            "Loading Level 3 province NPC images from LEVEL3 folder...",
        );
    ...
    loadLevel5NPCImages() {
        console.log(
            "Loading Level 5 national NPC images from LEVEL5 folder...",
        );
        ...
        this.load.image("dost-secretary", "assets/LEVEL5/dost-secretary.png");
        this.load.image(
            "ched-commissioner",
        ...
        this.load.image("dbm-secretary", "assets/LEVEL5/dbm-secretary.png");
        this.load.image("deped-secretary", "assets/LEVEL5/deped-secretary.png");
